...
/*
Se ao tentar conectar via Workbench, você receber a mensagem abaixo
...
CREATE TABLE Projeto (
    ...
    CONSTRAINT fk_proj_depto FOREIGN KEY (idDepto) REFERENCES Departamento (idDepto),
...
CREATE TABLE Dependente (
    ...
    CONSTRAINT fk_dep_func FOREIGN KEY (idFunc) REFERENCES Funcionario (idFunc) ON DELETE CASCADE,
...
CREATE TABLE Trabalha (
    ...
    CONSTRAINT pk_trab PRIMARY KEY (idFunc,idProj), CONSTRAINT fk_trab_func FOREIGN KEY (idFunc) REFERENCES Funcionario (idFunc) ON DELETE CASCADE,
    CONSTRAINT fk_trab_proj FOREIGN KEY (idProj) REFERENCES Projeto (idProj) ON DELETE CASCADE
);

INSERT INTO Funcionario VALUES (1,'João B. Silva','R. Guaicui, 175','1955/02/01','M',500,2,1);
INSERT INTO Funcionario VALUES (2,'Frank T. Santos','R. Gentios, 22','1966/02/02','M',1000,8,1);
INSERT INTO Funcionario VALUES (3,'Alice N. Pereira','R. Curitiba, 11','1970/05/15','F',700,4,3);
INSERT INTO Funcionario VALUES (4,'Júnia B. Mendes','R. E. Santos, 123','1976/07/06','F',1200,8,3);
INSERT INTO Funcionario VALUES (5,'José S. Tavares','R. Iraí, 153','1975/10/12','M',1500,2,1);
INSERT INTO Funcionario VALUES (6,'Luciana S. Santos','R. Iraí, 175','1960/10/10','F',600,2,1);
INSERT INTO Funcionario VALUES (7,'Maria P. Ramos','R. C. Linhares, 10','1965/11/05','F',1000,4,3);
INSERT INTO Funcionario VALUES (8,'Jaime A. Mendes','R. Bahia, 111','1960/11/25','M',2000,NULL,2);

INSERT INTO Departamento VALUES (1,'Pesquisa',2);
INSERT INTO Departamento VALUES (2,'Administração',8);
INSERT INTO Departamento VALUES (3,'Construção',4);

ALTER TABLE Funcionario ADD CONSTRAINT fk_func_depto FOREIGN KEY (idDepto) REFERENCES Departamento (idDepto);

ALTER TABLE Funcionario ADD CONSTRAINT fk_func_superv FOREIGN KEY (idSuperv) REFERENCES Funcionario (idFunc) ON DELETE SET NULL;

ALTER TABLE Departamento ADD CONSTRAINT fk_depto_func FOREIGN KEY (idGerente) REFERENCES Funcionario (idFunc);

INSERT INTO Dependente VALUES (1,2,'Luciana','1990/11/05','F','Filha');
INSERT INTO Dependente VALUES (2,2,'Paulo','1992/11/11','M','Filho');
INSERT INTO Dependente VALUES (3,2,'Sandra','1996/12/14','F','Filha');
...
INSERT INTO Dependente VALUES (7,1,'Bety','1960/12/17','F','Esposa');
...
INSERT INTO Projeto VALUES (10,'Computação','C. Nova',3);
INSERT INTO Projeto VALUES (20,'Organização','Luxemburgo',2);
INSERT INTO Projeto VALUES (30,'N. Benefícios','C. Nova',3);
